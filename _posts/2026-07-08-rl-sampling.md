...
I took the [Qwen2.5-1.5B-Instruct](https://huggingface.co/Qwen/Qwen2.5-1.5B-Instruct) model and picked a small model because conventional wisdom is that reasoning ability (eg coding) generally appears at mid sizes (32B+). I evaluated this model on the [gsm8k](https://huggingface.co/datasets/openai/gsm8k) math dataset for values: ``K=16``, ``K=64`` and ``K=128``. Everything ran on a single A100-SXM using the following generation params on SkyRL.
...
<img src="{{site.baseurl}}/assets/images/post_2_pass_16.png" title="Pass@16">
<img src="{{site.baseurl}}/assets/images/post_2_pass_64.png" title="Pass@64">
<img src="{{site.baseurl}}/assets/images/post_2_pass_128.png" title="Pass@128">
