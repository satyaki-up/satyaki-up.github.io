...
**Addendum**: I was also pointed to a [survey](https://safe-lip-9a8.notion.site/Incorrect-Baseline-Evaluations-Call-into-Question-Recent-LLM-RL-Claims-2012f1fbf0ee8094ab8ded1953c15a37) (Chandak, Goel, Prabhu (2025)) (thanks [Felix](https://www.linkedin.com/in/fbreuer)) about recent RL papers which seem to overstate what RL actually achieved. One common failure mode is sandbagging the baseline or not tuning its hyperparams a lot, but this is an [old problem](https://www.youtube.com/watch?v=wVkViYY_fwA).
